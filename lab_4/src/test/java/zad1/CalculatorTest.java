...
public class CalculatorTest {
    ...
    public void testIfNamesAreRandom() {
        ...
        String firstName1 = fakerGenerator.generateFirstName();
        String firstName2 = fakerGenerator.generateFirstName();
    ...
    public void testIfLastNamesAreRandom() {
        ...
        String lastName1 = fakerGenerator.generateLastName();
        String lastName2 = fakerGenerator.generateLastName();
